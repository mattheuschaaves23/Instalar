...
function getPixConfig() {
  ...
  return {
    ...
    recipientName: normalizeText(process.env.PIX_RECIPIENT_NAME || 'InstalaPro', 25),
    city: normalizeText(process.env.PIX_CITY || 'Sao Paulo', 15),
    description: normalizeText(process.env.PIX_DESCRIPTION || 'Assinatura InstalaPro', 40),
  };
}
